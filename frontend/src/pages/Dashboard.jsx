...
const Dashboard = () => {
  ...
  return (
    <div className='dashboard-container' style={{paddingLeft:'763px', paddingRight:'768px', marginLeft:'-600px'}}><br /><br />
      <div className='dashboard'>
        <Navbar />
        <h1>Dashboard</h1><br />
        <p style={{marginLeft:'-10px'}}>Welcome, {username}</p>
      ...
      <div className='dashboard-buttons'>
        <Link to="/" className='dashboard-button'>Home</Link>
      </div>
    </div>
  );
};
